...
public static class PartnerDataService
{
    ...
    /// <summary>
    /// Kiểm tra xem email của nhà cung cấp có hợp lệ hay chưa (không trùng với nhà cung cấp khác)
    /// </summary>
    /// <param name="email">Địa chỉ email cần kiểm tra</param>
    /// <param name="supplierID">
    /// Bằng 0 nếu kiểm tra email đối với nhà cung cấp mới.
    /// Khác 0 nếu kiểm tra email của nhà cung cấp có mã là <paramref name="supplierID"/>
    /// </param>
    /// <returns>
    /// True nếu email hợp lệ, False nếu email đã được sử dụng
    /// </returns>
